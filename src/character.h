...
namespace CMU462
{
   ...
   class Joint
   {
      public:
         ...
         bool calculateAngleGradient_helper(bool hasGoalJoint, Vector2D p, Vector2D q);
         ...
         void integrate_dynamic(double timestep, Vector2D cumulativeAcceleration);
   ...
   class Character
   {
      public:
         ...
         void reachForTarget( Joint* goalJoint,
               ...
               double time );
         Vector2D set_SourcePoint(Joint* goalJoint, Vector2D sourcePoint, double time);
